...
"[project]/src/Constantes.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Constantes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/Constantes.js [app-ssr] (ecmascript)");
...
function AuthProvider({ children }) {
    ...
    const { "token1": token1 } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseCookies"])();
    const { "contas": contas } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseCookies"])();
    /*  if(contasCookie != undefined){
        setContas(contasCookie);
    } */ async function signIn(username, password) {
        await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Constantes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].urlAdmin + 'admin/login', {
            method: 'POST',
            headers: {
            ...
            switch(status){
                case 200:
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(undefined, "token1", headers, {
                        path: "/"
                    });
                    body.forEach((_, index)=>{
                        body[index].principal = index == 0;
                    });
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(undefined, "contas", JSON.stringify(body), {
                        path: "/"
                    });
    ...
    async function getInfo(token1, id) {
        await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Constantes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].urlAdmin + 'admin/info?' + new URLSearchParams({
            accountId: id
        }), {
            method: 'GET',
            headers: {
            ...
            switch(status){
                case 200:
                    /* console.log(headers) */ if (contas != undefined) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(undefined, "contas", JSON.stringify(contasParse), {
                            path: "/"
                        });
                    }
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(undefined, "token2", headers, {
                        path: "/"
                    });
...
function RootLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (("TURBOPACK compile-time value", "development") === "development" && !token1) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nookies$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCookie"])(undefined, "token1", "fake_token_teste");
            router.push("/");
        } else if (!token1) {
            router.push("/login");
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("html", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$layout$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].root,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eafb4e85._.js.map